...
class Implementation:
    ...
    def recordMatch(self, name1, name2, winner=None, draw=False):
        ...
        # winner value should be either "W" or "L". If "W", then team1 is winner, if "L" then team2 is winner
        ...
        # There's something wrong with this logic. Penalizing team2 for team1's negative ranking. Commenting out for now.
        # if newRating1 < 0:
        #     newRating1 = 0
